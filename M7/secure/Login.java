...
public class Login {
    static HashMap<String, User> hash = new HashMap<>();
    ...
    public static void SignUp() {
        ...
        while(true) {
            ...
            if (PasswordField.passvalidation(password)) {
                break;
            } else {
        ...
        while(true) {
            ...
            String confirm = PasswordField.readPassword("");
    ...
    public static boolean forgotpassword(String name) {
        ...
        if (answer.equals(hash.get(name).getanswer())) {
            ...
            while (true) {
                ...
                String confirmpass = PasswordField.readPassword("");
